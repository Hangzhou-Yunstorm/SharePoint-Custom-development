...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostDownloadsReport.aspx.cs" Inherits="DocumentsSP.Layouts.MostDownloadsReport" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
        ...
        <div class="rightChart">
            ...
            <div class="titile_select">
                <select class="jumpMenu" tabindex="4">
                    ...
                    <option selected="selected" value="/_layouts/15/MostDownloadsReport.aspx">Most Downloads</option>
            ...
            <div class="title_date">
                <input type="button" class="get_btn" value="Generation" onclick="GetMDRDatas()" />
            </div>
    ...
    <script type="text/javascript" src="Scripts/MostDownloadsReport.js?v=2017-11-2"></script>
</asp:Content>

<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    Most Downloads Report
</asp:Content>
