...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUsers.aspx.cs" Inherits="DocumentsSP.Layouts.AddUsers" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/AddUsers.js?v=2018-06-12"></script>

</head>
<body>
    <form id="form1" runat="server">
        <div>
            <span>Please enter Group name: </span>&nbsp;&nbsp;&nbsp;&nbsp;<input style="width: 200px; height: 20px;" type="text" id="group_name" />
        </div>
        <hr />
        <div>
            <div class="ulSelect">
