...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogList.aspx.cs" Inherits="DocumentsSP.Layouts.LogList" DynamicMasterPageFile="~masterurl/default.master" %>

<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    <link href="Plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" />
    <link href="Plugins/Bootstrap-table/bootstrap-table.min.css" rel="stylesheet" />
    <link href="Content/LogList.css?v=2017-11-9" rel="stylesheet" />
    ...
    <div class="review">
        ...
        <div class="rightTable">
            <div id="toolbar">
                ...
                <input type="button" value="Search" onclick="SearchLog()" id="search_btn" />
                <input type="button" value="Maintain" onclick="Maintain()" id="maintain_btn" />
            </div>
            <table id="log_table" data-toolbar="#toolbar"></table>
        </div>
    </div>
    <script type="text/javascript" src="Scripts/LogList.js?v=2017-11-9"></script>
</asp:Content>
