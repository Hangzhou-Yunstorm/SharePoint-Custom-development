...
{
    public partial class BHDownload : LayoutsPageBase
    {
        /// <summary>
        /// 是否正在加密
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    CommonHelper.SetErrorLog("BHDownload.aspx__Page_Load", ex.Message);
                }
            }
        }
        ...
        private static SPFile GetFile(string hId)
        {
            ...
            using (SPSite site = new SPSite(siteId))
            {
                using (SPWeb web = site.OpenWeb())
                {
                    ...
                    {
                        CommonHelper.SetErrorLog("BHDownload.aspx__AddDCount", ex.Message);
                    }
