...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartDownloadsReport.aspx.cs" Inherits="DocumentsSP.Layouts.DepartDownloadsReport" DynamicMasterPageFile="~masterurl/default.master" %>

<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    <link href="Content/Report.css?v=2017-09-08" rel="stylesheet" />
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
        ...
        <div class="rightChart">
            ...
            <div class="titile_select">
                <select class="jumpMenu" tabindex="4">
                    ...
                    <option value="/_layouts/15/DocumentsScoreReport.aspx">Ducuments Score</option>
                    <option selected="selected" value="/_layouts/15/DepartDownloadsReport.aspx">Department Downloads</option>
            ...
            <div class="title_date">
                <input type="button" class="get_btn" value="Generation" onclick="GetDDRDatas()" />
            </div>
    ...
    <script type="text/javascript" src="Scripts/DepartDownloadsReport.js?v=2017-11-2"></script>
</asp:Content>

<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    Department Downloads Report
</asp:Content>
