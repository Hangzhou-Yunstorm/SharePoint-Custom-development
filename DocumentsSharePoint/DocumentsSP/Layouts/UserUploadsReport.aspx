...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserUploadsReport.aspx.cs" Inherits="DocumentsSP.Layouts.UserUploadsReport" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
        ...
        <div class="rightChart">
            ...
            <div class="titile_select">
                <select class="jumpMenu" tabindex="4">
                    ...
                    <option selected="selected" value="/_layouts/15/UserUploadsReport.aspx">User Uploads</option>
                </select>
            </div>
            <div class="title_date">
                <input type="button" class="get_btn" value="Generation" onclick="GetUURDatas()" />
            </div>
            ...
            <div id="group_select" class="title_date">
                <select class="group_type" tabindex="13">
                    <option selected="selected" value="All">All</option>
                    <%=groupsJson %>
                </select>
            </div>
    ...
    <script type="text/javascript" src="Scripts/UserUploadsReport.js?v=2017-11-2"></script>
</asp:Content>
