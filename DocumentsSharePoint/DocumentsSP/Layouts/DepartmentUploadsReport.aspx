...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartmentUploadsReport.aspx.cs" Inherits="DocumentsSP.Layouts.DepartmentUploadsReport" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
        ...
        <div class="rightChart">
            ...
            <div class="titile_select">
                <select class="jumpMenu" tabindex="4">
                    ...
                    <option selected="selected" value="/_layouts/15/DepartmentUploadsReport.aspx">Department Uploads</option>
                    <option value="/_layouts/15/UserUploadsReport.aspx">User Uploads</option>
                </select>
            </div>
            <div class="title_date">
                <input type="button" class="get_btn" value="Generation" onclick="GetDURDatas()" />
            </div>
    ...
    <script type="text/javascript" src="Scripts/DepartUploadsReport.js?v=2017-11-2"></script>
</asp:Content>

<asp:Content ID="PageTitle" ContentPlaceHolderID="PlaceHolderPageTitle" runat="server">
    Department Uploads Report
</asp:Content>
