...
{
    public partial class SubscribeMulDownload : LayoutsPageBase
    {
        /// <summary>
        /// 初始化
        /// </summary>
        ...
        /// <returns></returns>
        [WebMethod]
        public static string SubscribeDownLoadZIP(string listId)
        {
                    ...
                    using (SPSite site = new SPSite(siteId))
                    {
                        using (SPWeb web = site.OpenWeb())
                        {
                            ...
                            for (int i = 0; i < fileIds.Length - 1; i++)
                            {
                                ...
                                //var item = sdl.GetItemByUniqueId(g);
            ...
            {
                CommonHelper.SetErrorLog("SubscribeMulDownload.aspx__Page_Load", ex.Message);
        ...
        private static void BHCreateZipFile(string filesPath, string zipFilePath)
        {
            ...
            {
                CommonHelper.SetErrorLog("SubscribeMulDownload.aspx__CreateZipFile", ex.Message);
            }
        }
    }
}
