...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MostDownLoadFiles.aspx.cs" Inherits="DocumentsSP.Layouts.MostDownLoadFiles" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="Scripts/MostDownloads.js?v=2017-09-25"></script>
</asp:Content>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div class='splitters' id="title_div">
        <span id="r_title">Most Downloads</span>
        <img onclick='MostDownLoad()' style='float: right; cursor: pointer;' src='/_layouts/15/Images/down1.png' alt='Download file'>
    </div>
