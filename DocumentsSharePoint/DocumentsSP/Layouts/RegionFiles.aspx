...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegionFiles.aspx.cs" Inherits="DocumentsSP.Layouts.RegionFiles" DynamicMasterPageFile="~masterurl/default.master" %>
...
<asp:Content ID="PageHead" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
    ...
    <script type="text/javascript" src="Scripts/RegionFiles.js?v=2017-09-25"></script>
</asp:Content>
...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div class='splitters' id="title_div">
        <span id="r_title">Region Files</span>
        <img onclick='RegionDownLoad()' style='float: right; cursor: pointer;' src='/_layouts/15/Images/down1.png' alt='Download file'>
    </div>
